{if $debug}
  ...
  <script type="text/javascript" src="{$urlAdmidio}/libs/jquery-ui/jquery-ui.js"></script>
  ...
  <link rel="stylesheet" type="text/css" href="{$urlAdmidio}/libs/jquery-ui/jquery-ui.css" />
{else}
  <script type="text/javascript" src="{$urlAdmidio}/libs/jquery/jquery.min.js"></script>
  <script type="text/javascript" src="{$urlAdmidio}/libs/jquery-ui/jquery-ui.min.js"></script>
