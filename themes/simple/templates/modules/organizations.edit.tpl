<form {foreach $attributes as $attribute}
    ...
    {/if}
    {if {array_key_exists array=$elements key='org_suborg_use_same_members'}}
        {include 'sys-template-parts/form.checkbox.tpl' data=$elements['org_suborg_use_same_members']}
    {/if}
