...
class Message extends Entity
{
    ...
    /**
     * @var array with Entity objects
     */
    protected array $msgRecipientsObjectArray = array();
    /**
     * @var object of Entity for the current content of the message.
     */
    ...
    public function addRole(int $roleID, int $roleMode, string $roleName = '')
    {
        ...
        $messageRecipient = new Entity($this->db, TBL_MESSAGES_RECIPIENTS, 'msr');
    ...
    public function addUser(int $userID, string $fullName = '')
    {
        ...
        // if user doesn't exist in recipient list than save recipient as Entity object to the array
        $messageRecipient = new Entity($this->db, TBL_MESSAGES_RECIPIENTS, 'msr');
        $messageRecipient->setValue('msr_msg_id', $this->getValue('msg_id'));
