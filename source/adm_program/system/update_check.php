...
if($getMode == 2)
{
   ...
   echo'
    <ul class="noStyleList">
        <li>'.$gL10n->get('UPD_CURRENT_VERSION').':&nbsp;'.ADMIDIO_VERSION. BETA_VERSION_TEXT.'</li>
        <li>'.$gL10n->get('UPD_STABLE_VERSION').':&nbsp;<a href="http://www.admidio.org/index.php?page=download"" target="_blank" title="'.$gL10n->get('UPD_ADMIDIO').'">'.$stable_version. '</a></li>
        <li>
            '.$gL10n->get('UPD_BETA_VERSION').': &nbsp;<a href="http://www.admidio.org/index.php?page=download"" target="_blank" title="'.$gL10n->get('UPD_ADMIDIO').'">'.$beta_version;
