                ...
                if(isMember($row->usr_id))
                {
                    ...
                    if(strlen($row->usr_login_name) > 0)
                    {
                        ...
                        if($gPreferences['enable_system_mails'] == 1)
                        {
                            ...
                            <a class="icon-text-link" href="'.$g_root_path.'/adm_program/administration/new_user/new_user_function.php?new_user_id='.$getNewUserId.'&amp;user_id='.$row->usr_id.'&amp;mode=6"><img
                    ...
                    else
                    {
                        ...
                        <a class="icon-text-link" href="'.$g_root_path.'/adm_program/administration/new_user/new_user_function.php?new_user_id='.$getNewUserId.'&amp;user_id='.$row->usr_id.'&amp;mode=1"><img
