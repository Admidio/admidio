            ...
            <thead>
                <tr>
                    ...
                    <th style=\"width: 27%;\">Bedingung
                        <img class=\"iconHelpLink\" src=\"". THEME_PATH. "/icons/help.png\" alt=\"Hilfe\" titel=\"Hilfe\"                     onclick=\"window.open('$g_root_path/adm_program/system/msg_window.php?err_code=condition&amp;window=true','Message','width=650,height=400,left=310,top=200,scrollbars=no')\" onmouseover=\"ajax_showTooltip('$g_root_path/adm_program/system/msg_window.php?err_code=condition',this);\" onmouseout=\"ajax_hideTooltip()\"/>
                    </th>
                </tr>
            </thead>
            <tbody>";            
