...
echo '<form id="ecard_form" action="javascript:ecardJS.makePreview();" method="post">
		<input type="hidden" name="ecard[image_name]" value="'.$g_root_path.'/adm_program/modules/photos/photo_show.php?pho_id='.$pho_id.'&pic_nr='.$photo.'&pho_begin='.$photo_album->getValue('pho_begin').'&max_width='.$g_preferences['ecard_card_picture_width'].'&max_height='.$g_preferences['ecard_card_picture_height'].'" />
