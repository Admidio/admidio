...
$page->addJavascript('
    profileJS.init();
    $(".icon-link-delete").colorbox({rel:\'nofollow\', scrolling:false, onComplete:function(){$("#admButtonNo").focus();}});
    ...
    <div class="panel-body">
        ...
        <div class="col-sm-4 text-right">');
            ...
            if($gCurrentUser->editProfile($user) == true)
            {
                ...
                {
                    $page->addHtml('<li><a class="icon-text-link icon-link-delete" href="'.$g_root_path.'/adm_program/system/popup_message.php?type=pro_pho&amp;element_id=no_element'.
...
if($gPreferences['profile_show_roles'] == 1)
{
    ...
    <div class="panel panel-default" id="profile_authorizations_box">
        ...
        <div class="panel-body" id="profile_authorizations_box_body">
            ...
            {
                $page->addHtml('<img onmouseover="profileJS.showInfo(\''.substr($berechtigungs_Herkunft['rol_guestbook_comments'],2).'\')" class="icon-information" src="'.THEME_PATH.'/icons/comments.png"
