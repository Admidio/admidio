                        ...
                        <div class="admFieldRow">
                            ...
                            <div class="admFieldElement"><i>');
                                if(strlen($user->getValue('usr_login_name')) > 0)
                                {
                                    if ($user->getValue('usr_id') != $gCurrentUser->getValue('usr_id'))
                                    {
                                        $page->addHtml('<a href='.$g_root_path.'/adm_program/modules/messages/messages_write.php?msg_type=PM&usr_id='.$user->getValue('usr_id').'>'.$user->getValue('usr_login_name').'</a>');
                                    }
                                    else
                                    {
