...
$form->openGroupBox('gb_name_properties', $gL10n->get('SYS_NAME').' &amp; '.$gL10n->get('SYS_PROPERTIES'));
    ...
    $form->addTextInput('room_capacity', $gL10n->get('ROO_CAPACITY').' ('.$gL10n->get('ROO_SEATING').')', $room->getValue('room_capacity'), 5, FIELD_MANDATORY, 'number');
    $form->addTextInput('room_overhang', $gL10n->get('ROO_OVERHANG'), $room->getValue('room_overhang'), 5, FIELD_DEFAULT, 'number', 'DAT_ROOM_OVERHANG');
$form->closeGroupBox();
