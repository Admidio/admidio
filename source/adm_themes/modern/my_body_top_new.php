...
<div id="page">
    <div id="header-block" class="admContent"><h1><?php echo $gCurrentOrganization->getValue("org_longname"); ?></h1></div>
    <div id="left-block" class="admContent">
        <?php
	...
	<div id="right-block" class="admContent">
