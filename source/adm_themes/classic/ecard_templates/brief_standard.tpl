    ...
    <td id="card_form" colspan="2" style="border: 1px solid rgb(0, 0, 0); padding: 10px; ">
	 ...
	 <tbody><tr>
	  ...
	  <table  border="0" cellpadding="0" cellspacing="2">
	   ...
	   <tr>
	    <td align="center"><img src="<%ecard_image_name%>" width="<%ecard_image_width%>" height="<%ecard_image_height%>" style="border: 0px; margin: 10pt 10px 10px 10pt; padding: 4px;" alt="Gru&szlig;karte"></td>
	   </tr>
       <tr>
	  ...
	  <table  border="0" cellpadding="0" cellspacing="2" style="height:100%" summary="Sender Data">
           <tbody>
               <tr style="vertical-align:top; margin:5px 5px 5px 5px;">
                <td>
                      <div align="right">
                        <img src="<%theme_root_path%>/images/stamp.png" alt="Briefmarke"  border="0" height="129" width="150">
                      </div>
                </td>
               </tr>
               <tr>
