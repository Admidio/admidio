...
<body>
    <div align="center" style="margin-top: 30px;">
        <%ecard_greeting_card_from%>: <strong><a href="<%g_root_path%>/modules/messages/messages_write.php?user_uuid=<%ecard_sender_id%>" target="_blank"><%ecard_sender_name%></a></strong>
    </div>
