...
INSERT INTO %PREFIX%_preferences (prf_id, prf_org_id, prf_name, prf_value) VALUES
    ...
    (94200, 1, 'changelog_enable_module', '1'),
    (94201, 1, 'changelog_table_user_data', '1'),
    (94202, 1, 'changelog_table_users', '1'),
    (94203, 1, 'changelog_table_members', '1'),
    (94204, 1, 'changelog_table_user_fields', '0'),
    (94205, 1, 'changelog_table_announcements', '0'),
    (94206, 1, 'changelog_table_events', '0'),
    (94207, 1, 'changelog_table_rooms', '0'),
    (94208, 1, 'changelog_table_roles', '0'),
    (94209, 1, 'changelog_table_role_dependencies', '0'),
    (94210, 1, 'changelog_table_roles_rights', '0'),
    (94211, 1, 'changelog_table_roles_rights_data', '0'),
    (94212, 1, 'changelog_table_categories', '0'),
    (94213, 1, 'changelog_table_category_report', '0'),
    (94214, 1, 'changelog_table_guestbook', '0'),
    (94215, 1, 'changelog_table_guestbook_comments', '0'),
    (94216, 1, 'changelog_table_links', '0'),
    (94217, 1, 'changelog_table_folders', '0'),
    (94218, 1, 'changelog_table_files', '0'),
    (94219, 1, 'changelog_table_organizations', '0'),
    (94220, 1, 'changelog_table_menu', '0'),
    (94221, 1, 'changelog_table_user_relation_types', '0'),
    (94222, 1, 'changelog_table_user_relations', '1'),
    (94223, 1, 'changelog_table_photos', '0'),
    (94224, 1, 'changelog_table_lists', '0'),
    (94225, 1, 'changelog_table_list_columns', '0'),
    (94226, 1, 'changelog_table_preferences', '0'),
    (94227, 1, 'changelog_table_texts', '0'),
    (94228, 1, 'changelog_table_others', '0'),
    (94300, 2, 'changelog_enable_module', '0'),
    (94301, 2, 'changelog_table_user_data', '1'),
    (94302, 2, 'changelog_table_users', '1'),
    (94303, 2, 'changelog_table_members', '1'),
    (94304, 2, 'changelog_table_user_fields', '0'),
    (94305, 2, 'changelog_table_announcements', '0'),
    (94306, 2, 'changelog_table_events', '0'),
    (94307, 2, 'changelog_table_rooms', '0'),
    (94308, 2, 'changelog_table_roles', '0'),
    (94309, 2, 'changelog_table_role_dependencies', '0'),
    (94310, 2, 'changelog_table_roles_rights', '0'),
    (94311, 2, 'changelog_table_roles_rights_data', '0'),
    (94312, 2, 'changelog_table_categories', '0'),
    (94313, 2, 'changelog_table_category_report', '0'),
    (94314, 2, 'changelog_table_guestbook', '0'),
    (94315, 2, 'changelog_table_guestbook_comments', '0'),
    (94316, 2, 'changelog_table_links', '0'),
    (94317, 2, 'changelog_table_folders', '0'),
    (94318, 2, 'changelog_table_files', '0'),
    (94319, 2, 'changelog_table_organizations', '0'),
    (94320, 2, 'changelog_table_menu', '0'),
    (94321, 2, 'changelog_table_user_relation_types', '0'),
    (94322, 2, 'changelog_table_user_relations', '1'),
    (94323, 2, 'changelog_table_photos', '0'),
    (94324, 2, 'changelog_table_lists', '0'),
    (94325, 2, 'changelog_table_list_columns', '0'),
    (94326, 2, 'changelog_table_preferences', '0'),
    (94327, 2, 'changelog_table_texts', '0'),
    (94328, 2, 'changelog_table_others', '0');
