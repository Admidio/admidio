...
try {
    ...
    if ($type === 'oidc') {
        try {
            ...
            echo json_encode(['error' => 'OIDC service setup failed: ' . $htmlPurifierFilter->purify($e->getMessage())]);
            exit;
        }
        ...
        try {
            ...
            echo json_encode(['error' => 'OIDC Error in Admidio: ' . $htmlPurifierFilter->purify($e->getMessage())]);
            exit;
        }
