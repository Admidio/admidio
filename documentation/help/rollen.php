...
<td style="background-color: #ffffff; padding-left: 15px;">
   ...
   <ul style="padding-left: 15px;">
      ...
      <li>
         ...
         <p><img style="vertical-align: bottom;" src="help/images/lock.png" alt="Gesperrte Rolle" />&nbsp;
      ...
      <li>
         ...
         <p><img style="vertical-align: bottom;" src="help/images/wand.png" alt="Moderation" />&nbsp;
         ...
         <p><img style="vertical-align: bottom;" src="help/images/user.png" alt="Benutzer bearbeiten" />&nbsp;
         ...
         <p><img style="vertical-align: bottom;" src="help/images/note.png" alt="Ank&uuml;ndigungen" />&nbsp;
         Benutzer k&ouml;nnen Ank&uuml;ndigungen anlegen (keine Termine) und diese
         sp&auml;ter auch bearbeiten oder l&ouml;schen.</p>
         <p><img style="vertical-align: bottom;" src="help/images/date.png" alt="Termine" />&nbsp;
         Benutzer k&ouml;nnen eigene Termine anlegen (keine Ank&uuml;ndigungen) und diese
         sp&auml;ter auch bearbeiten oder l&ouml;schen.</p>
         <p><img style="vertical-align: bottom;" src="help/images/photo.png" alt="Foto" />&nbsp;
         ...
         <p><img style="vertical-align: bottom;" src="help/images/folder.png" alt="Download" />&nbsp;
         ...
         <p><img style="vertical-align: bottom;" src="help/images/mail.png" alt="Mail ausgeloggt" />&nbsp;
         ...
         <p><img style="vertical-align: bottom;" src="help/images/mail_key.png" alt="Mail eingeloggt" />&nbsp;
         ...
         <p><img style="vertical-align: bottom;" src="help/images/globe.png" alt="Weblinks" />&nbsp;
   ...
   <div style="text-align: left;">
      <a href="index.php?help/layout.php"><img src="help/images/back.png" style="vertical-align: bottom; border: 0px;" alt="Admidio dem eigenen Layout anpassen" title="Admidio dem eigenen Layout anpassen" /></a>
   </div>
</td>