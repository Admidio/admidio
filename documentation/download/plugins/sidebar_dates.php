...
<td style="background-color: #ffffff; padding-left: 15px;">
    <h2>Sidebar Dates</h2>
    <p>Dieses Plugin listet die letzten x Termine mit einem Link zum Terminmodul auf. Da es sehr wenig Platz 
    ...
    <p>Diese Version von Sidebar Dates ist kompatibel zur Admidio-Version 1.2 bis 1.4</p>
    
    <div style="background-color: #eeeeee; padding: 5px; -moz-border-radius: 10px;">
        <table style="border: 0px;">
            <tr>
                <td>&nbsp;
                    <a href="http://prdownloads.sourceforge.net/plugins/sidebar_dates_1.0.zip?download">
                    sidebar_dates_1.0.zip</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
                <td>
                    Version: <b>1.0</b>
                </td>
    ...
    <p>Ein Beispiel f&uuml;r eine Integration von mehreren Plugins (unter anderem auch Sidebar Dates) in einer Seitenleiste 
