...
-------------------------------------------------------------------------
 ...
 1. Introduction
-------------------------------------------------------------------------
This plugin will show a small login form where the user is able to enter
the login data and call the verification of his data. A registered user
...
Please don't forget to add the login_form.css to the head of your html page.
 ...
 3. Update
-------------------------------------------------------------------------
To update this plugin you should only replace the login_form.php
