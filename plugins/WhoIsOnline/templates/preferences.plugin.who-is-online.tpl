<form {foreach $attributes as $attribute}
    ...
    {include 'sys-template-parts/form.input.tpl' data=$elements['who_is_online_plugin_time_still_active']}
    {include 'sys-template-parts/form.checkbox.tpl' data=$elements['who_is_online_plugin_show_visitors']}
    {include 'sys-template-parts/form.select.tpl' data=$elements['who_is_online_plugin_show_members_to_visitors']}
