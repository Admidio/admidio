                            ...
                            <tr>
                                ...
                                <td>';
                                    ...
                                    if($date->getValue('dat_room_id')>0)
                                    {
                                        ...
                                        echo '<strong> (<a class="thickbox" href="'. $g_root_path. '/adm_program/system/msg_window.php?message_id=room_detail&amp;message_title='.$g_l10n->get('DAT_ROOM_INFORMATIONS').'&amp;message_text='.$date->getValue('dat_room_id').'&amp;window=true&amp;KeepThis=true&amp;TB_iframe=true&amp;height=300&amp;width=580&amp;modal=true">'.$room_name.'</a>)</strong>';
                                    }
                                    echo '
                                </td>
                            </tr>';
                    ...
                    else 
                    {
                        ...
                        if($date->getValue('dat_room_id')>0)
                        {
                            ...
                            <tr>
                                <td>'.$g_l10n->get('DAT_LOCATION').':</td>
                                <td>
                                    <strong><a class="thickbox" href="'. $g_root_path. '/adm_program/system/msg_window.php?message_id=room_detail&amp;message_title='.$g_l10n->get('DAT_ROOM_INFORMATIONS').'&amp;message_text='.$date->getValue('dat_room_id').'&amp;window=true&amp;KeepThis=true&amp;TB_iframe=true&amp;height=300&amp;width=580&amp;modal=true">'.$room_name.'</a></strong>
                                </td>
                            </tr>';
                            if ($date->getValue("dat_all_day") != 0)
                            {
