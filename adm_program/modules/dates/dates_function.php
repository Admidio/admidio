...
{
    $member = new TableMembers($gDb);
    $member->startMembership((int) $date->getValue('dat_rol_id'), (int) $gCurrentUser->getValue('usr_id'), '', 2);
...
{
    $member = new TableMembers($gDb);
    $member->startMembership((int) $date->getValue('dat_rol_id'), (int) $gCurrentUser->getValue('usr_id'), '', 1);
