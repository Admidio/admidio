...
if($getMode === 2)
{
    ...
    {
        $validFromDate = \DateTime::createFromFormat($gSettingsManager->get('system_date'), $_POST['rol_start_date']);
        if(!$validFromDate)
        {
            $gMessage->show($gL10n->get('SYS_DATE_INVALID', $gL10n->get('ROL_VALID_FROM'), $gSettingsManager->get('system_date')));
            // => EXIT
        }
        else
        {
    ...
    {
        $validToDate = \DateTime::createFromFormat($gSettingsManager->get('system_date'), $_POST['rol_end_date']);
        if(!$validToDate)
        {
            $gMessage->show($gL10n->get('SYS_DATE_INVALID', $gL10n->get('ROL_VALID_TO'), $gSettingsManager->get('system_date')));
            // => EXIT
        }
        else
        {
    ...
    {
        $validFromTime = \DateTime::createFromFormat('Y-m-d '.$gSettingsManager->get('system_time'), DATE_NOW.' '.$_POST['rol_start_time']);
        if(!$validFromTime)
        {
            $gMessage->show($gL10n->get('SYS_TIME_INVALID', $gL10n->get('ROL_TIME_FROM'), $gSettingsManager->get('system_time')));
            // => EXIT
        }
        else
        {
    ...
    {
        $validToTime = \DateTime::createFromFormat('Y-m-d '.$gSettingsManager->get('system_time'), DATE_NOW.' '.$_POST['rol_end_time']);
        if(!$validToTime)
        {
            $gMessage->show($gL10n->get('SYS_TIME_INVALID', $gL10n->get('ROL_TIME_TO'), $gSettingsManager->get('system_time')));
            // => EXIT
        }
        else
        {
