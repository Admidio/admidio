            ...
            <div class="panel-heading">
                ...
                <div class="pull-right text-right">'. $gbComment->getValue('gbc_timestamp_create', $gPreferences['system_date'].' '.$gPreferences['system_time']);
                    ...
                    if ($gCurrentUser->editGuestbookRight())
                    {
                        ...
                        <a class="icon-link icon-link-popup" href="'.$g_root_path.'/adm_program/system/popup_message.php?type=gbc&amp;element_id=gbc_'.
            ...
            <div class="panel-body">'.
                ...
                if($getModeration == 1)
                {
                    ...
                    <ul class="icon-text-link-list icon-text-link-list-horizontal">
                        <li>
                            <a class="icon-text-link icon-link-popup" href="'.$g_root_path.'/adm_program/system/popup_message.php?type=gbc_mod&amp;element_id=gbc_'.$gbComment->getValue('gbc_id').'&amp;database_id='.
                        ...
                        <li>
                            <a class="icon-text-link icon-link-popup" href="'.$g_root_path.'/adm_program/system/popup_message.php?type=gbc&amp;element_id=gbc_'.$gbComment->getValue('gbc_id').'&amp;database_id='.
