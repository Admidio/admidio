...
// create html form
$form = new HtmlForm('edit_download_form', ADMIDIO_URL.'/adm_program/modules/downloads/download_function.php?mode=4&amp;folder_id='.$getFolderId.'&amp;file_id='.$getFileId, $page);
if ($getFileId)
{
