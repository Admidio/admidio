...
function deleteThumbnail(&$photo_album, $pic_nr)
{
    if(is_numeric($pic_nr))
    {
        ...
        $photo_path = ADMIDIO_PATH. '/adm_my_files/photos/'.$photo_album->getValue('pho_begin', 'Y-m-d').'_'.$photo_album->getValue('pho_id').'/thumbnails/'.$pic_nr.'.jpg';
...
function deletePhoto($pho_id, $pic_nr)
{
    ...
    if(is_numeric($pho_id) && is_numeric($pic_nr))
    {
        ...
        // Speicherort
        $album_path = ADMIDIO_PATH. '/adm_my_files/photos/'.$photo_album->getValue('pho_begin', 'Y-m-d').'_'.$photo_album->getValue('pho_id');
...
if($getJob === 'rotate')
{
    ...
    if($getDirection !== '')
    {
        ...
        // Ordnerpfad zusammensetzen
        $photo_path = ADMIDIO_PATH. '/adm_my_files/photos/'.$photo_album->getValue('pho_begin', 'Y-m-d').'_'.$photo_album->getValue('pho_id'). '/'. $getPhotoNr. '.jpg';
