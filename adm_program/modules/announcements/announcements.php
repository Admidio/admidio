 ...
 * cat_id    : Show only announcements of this category id, if id is not set than show all announcments.
            ...
            <div class="panel-heading">
                ...
                <div class="pull-right text-right">'.$announcement->getValue('ann_timestamp_create', $gPreferences['system_date']));
                    ...
                    if($gCurrentUser->editAnnouncements())
                    {
                        ...
                        {
                            $page->addHtml('
                            <a class="admidio-icon-link" href="'.$g_root_path.'/adm_program/modules/announcements/announcements_new.php?ann_id='. $announcement->getValue('ann_id'). '&amp;copy=1&amp;headline='.$getHeadline.'"><img
