...
if($getMode === 2)
{
    ...
    header('Location: '.ADMIDIO_URL.'/adm_program/modules/profile/roles.php?usr_id='.$getUserId);
    exit();
}
...
elseif($getMode === 6)
{
    ...
    header('Location: '.ADMIDIO_URL.'/adm_program/modules/members/members_function.php?mode=4&usr_id='.$getUserId);
    exit();
}
