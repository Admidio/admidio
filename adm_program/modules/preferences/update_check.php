...
function CheckVersion($current_version, $check_stable_version, $check_beta_version, $beta_release, $beta_flag)
{
    ...
    if(version_compare($check_stable_version, $current_version) === 1)
    {
        $update = 1;
    }
    ...
    echo'
        ...
        <p>'.$gL10n->get('UPD_STABLE_VERSION').':&nbsp;
            <a class="btn" href="http://www.admidio.org/index.php?page=download" target="_blank">
                <img src="'.THEME_PATH.'/icons/update_link.png" alt="'.$gL10n->get('UPD_ADMIDIO').'" />'.$stable_version. '
            </a>
            <br />
    ...
    if($version_update !== 99 && $beta_version !== 'n/a')
    {
        echo '
            <a class="btn" href="http://www.admidio.org/index.php?page=download" target="_blank">
                ...
                '.$beta_version.'&nbsp;Beta&nbsp;'.$beta_release.'
            </a>';
    }
    else
    {
