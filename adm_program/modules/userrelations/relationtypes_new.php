...
$form->addCheckbox(
    'urt_edit_user', $gL10n->get('REL_EDIT_USER_BACKWARD'), (bool) $relationtype1->getValue('urt_edit_user'), array('helpTextIdLabel' => 'REL_EDIT_USER_DESC')
);
...
$form->addCheckbox(
    'urt_edit_user_inverse', $gL10n->get('REL_EDIT_USER_FORWARD'), (bool) $relationtype1->getValue('urt_edit_user_inverse'), array('helpTextIdLabel' => 'REL_EDIT_USER_DESC')
);
