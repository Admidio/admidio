	 ...
	 <tbody><tr>
	  ...
	  <table border="0" cellpadding="1" cellspacing="2">
	   <tbody><tr>
		...
		<table border="0" cellpadding="0" cellspacing="0">
		 <tbody><tr>
		  <td id="card_stamp" style="width: 101px; height: 59px;" align="right"><div align="right"><img src="templates/Briefmarke.jpg" alt="frame" border="0" height="59" width="101"></div></td>
