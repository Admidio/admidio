...
$form->addCustomContent($gL10n->get('SYS_PHOTO'), '
    <a data-toggle="lightbox" data-type="image" data-title="'.$gL10n->get('SYS_PREVIEW').'"
        href="'.ADMIDIO_URL.FOLDER_MODULES.'/photos/photo_show.php?pho_id='.$getPhotoId.'&amp;photo_nr='.$getPhotoNr.'&amp;max_width='.$gSettingsManager->getInt('photo_show_width').'&amp;max_height='.$gSettingsManager->getInt('photo_show_height').'"><img
        src="'.ADMIDIO_URL.FOLDER_MODULES.'/photos/photo_show.php?pho_id='.$getPhotoId.'&amp;photo_nr='.$getPhotoNr.'&amp;max_width='.$gSettingsManager->getInt('ecard_thumbs_scale').'&amp;max_height='.$gSettingsManager->getInt('ecard_thumbs_scale').'"
