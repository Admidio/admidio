...
$imageUrl = ADMIDIO_URL.FOLDER_MODULES.'/photos/photo_show.php?pho_id='.$postPhotoId.'&photo_nr='.$postPhotoNr.'&max_width='.$gSettingsManager->get('ecard_thumbs_scale').'&max_height='.$gSettingsManager->get('ecard_thumbs_scale');
