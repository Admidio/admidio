...
$imageUrl = ADMIDIO_URL.FOLDER_MODULES.'/photos/photo_show.php?pho_id='.$postPhotoId.'&photo_nr='.$postPhotoNr.'&max_width='.$gSettingsManager->getInt('ecard_thumbs_scale').'&max_height='.$gSettingsManager->getInt('ecard_thumbs_scale');
