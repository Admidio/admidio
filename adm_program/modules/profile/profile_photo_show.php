...
else
{
    ...
    if((int) $gSettingsManager->get('profile_photo_storage') === 1 && !$getNewPhoto)
    {
    ...
    elseif((int) $gSettingsManager->get('profile_photo_storage') === 0 && !$getNewPhoto)
    {
    ...
    elseif((int) $gSettingsManager->get('profile_photo_storage') === 1 && $getNewPhoto)
    {
