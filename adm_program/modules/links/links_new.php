...
$linksCreateMenu = new HtmlNavbar('menu_links_create', $headline, $page);
...
$form->addInput('lnk_name', $gL10n->get('LNK_LINK_NAME'), $link->getValue('lnk_name'), array('maxLength' => 250, 'property' => FIELD_MANDATORY));
$form->addInput('lnk_url', $gL10n->get('LNK_LINK_ADDRESS'), $link->getValue('lnk_url'), array('type' => 'url', 'maxLength' => 2000, 'property' => FIELD_MANDATORY));
$form->addSelectBoxForCategories('lnk_cat_id', $gL10n->get('SYS_CATEGORY'), $gDb, 'LNK', 'EDIT_CATEGORIES', 
                                 array('property' => FIELD_MANDATORY, 'defaultValue' => $link->getValue('lnk_cat_id')));
