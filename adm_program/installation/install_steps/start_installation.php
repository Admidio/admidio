...
$sql = 'INSERT INTO '.TBL_USER_FIELDS.'
        ...
        VALUES ('.$categoryIdSocialNetworks.', \'' . Uuid::uuid4() . '\', \'TEXT\', \'FACEBOOK\',              \'SYS_FACEBOOK\',    \''.$gL10n->get('SYS_SOCIAL_NETWORK_FIELD_URL_DESC').'\',       \'fab fa-facebook\',    \'https://www.facebook.com/#user_content#\',      false, 1, '.$gCurrentUserId.', \''. DATETIME_NOW.'\')
             , ('.$categoryIdSocialNetworks.', \'' . Uuid::uuid4() . '\', \'TEXT\', \'LINKEDIN\',              \'SYS_LINKEDIN\',    \''.$gL10n->get('SYS_SOCIAL_NETWORK_FIELD_URL_DESC').'\', \'fab fa-linkedin\',    \'https://www.linkedin.com/in/#user_content#\',   false, 2, '.$gCurrentUserId.', \''. DATETIME_NOW.'\')
             , ('.$categoryIdSocialNetworks.', \'' . Uuid::uuid4() . '\', \'TEXT\', \'SKYPE\',                 \'SYS_SKYPE\',       \''.$gL10n->get('SYS_SOCIAL_NETWORK_FIELD_DESC').'\',          \'fab fa-skype\',       NULL,                                             false, 3, '.$gCurrentUserId.', \''. DATETIME_NOW.'\')
             , ('.$categoryIdSocialNetworks.', \'' . Uuid::uuid4() . '\', \'TEXT\', \'TWITTER\',               \'SYS_TWITTER\',     \''.$gL10n->get('SYS_SOCIAL_NETWORK_FIELD_URL_DESC').'\',        \'fab fa-twitter\',     \'https://twitter.com/#user_content#\',           false, 4, '.$gCurrentUserId.', \''. DATETIME_NOW.'\')
             , ('.$categoryIdSocialNetworks.', \'' . Uuid::uuid4() . '\', \'TEXT\', \'XING\',                  \'SYS_XING\',        \''.$gL10n->get('SYS_SOCIAL_NETWORK_FIELD_URL_DESC').'\',           \'fab fa-xing\',        \'https://www.xing.com/profile/#user_content#\',  false, 5, '.$gCurrentUserId.', \''. DATETIME_NOW.'\')';
$db->query($sql); // TODO add more params
...
$sql = 'INSERT INTO '.TBL_MENU.'
        ...
        VALUES (NULL, NULL, \'' . Uuid::uuid4() . '\', true, 1, true, \'modules\', NULL, \'\', \'SYS_MODULES\', \'\')
             ...
             , ((SELECT com_id FROM '.TBL_COMPONENTS.' WHERE com_name_intern = \'PHOTOS\'), 1, \'' . Uuid::uuid4() . '\', false, 5, true, \'photo\', \''.FOLDER_MODULES.'/photos/photos.php\', \'fa-image\', \'SYS_PHOTOS\', \'SYS_PHOTOS_DESC\')
             ...
             , ((SELECT com_id FROM '.TBL_COMPONENTS.' WHERE com_name_intern = \'EVENTS\'), 1, \'' . Uuid::uuid4() . '\', false, 8, true, \'events\', \''.FOLDER_MODULES.'/events/events.php\', \'fa-calendar-alt\', \'SYS_EVENTS\', \'SYS_EVENTS_DESC\')
             ...
             , ((SELECT com_id FROM '.TBL_COMPONENTS.' WHERE com_name_intern = \'CONTACTS\'), 2, \'' . Uuid::uuid4() . '\', false, 2, true, \'contacts\', \''.FOLDER_MODULES.'/contacts/contacts.php\', \'fa-address-card\', \'SYS_CONTACTS\', \'SYS_CONTACTS_DESC\')
