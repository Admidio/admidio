...
$sql = 'INSERT INTO '.TBL_MENU.'
        ...
        VALUES (NULL, NULL, \'' . Uuid::uuid4() . '\', true, 1, true, \'modules\', NULL, \'\', \'SYS_MODULES\', \'\')
             ...
             , ((SELECT com_id FROM '.TBL_COMPONENTS.' WHERE com_name_intern = \'DATES\'), 1, \'' . Uuid::uuid4() . '\', false, 8, true, \'dates\', \''.FOLDER_MODULES.'/events/events.php\', \'fa-calendar-alt\', \'DAT_DATES\', \'SYS_EVENTS_DESC\')
