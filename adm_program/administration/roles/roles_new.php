...
echo "
<form action=\"$g_root_path/adm_program/administration/roles/roles_function.php?rol_id=$req_rol_id&amp;mode=2\" method=\"post\">
            ...
            <ul class=\"formFieldList\">
                <li>
                    <dl>
                        ...
                        <dd>
                            ...
                            echo " style=\"width: 320px;\" maxlength=\"50\" value=\"". htmlspecialchars($role->getValue("rol_name"), ENT_QUOTES). "\">
                ...
                <li>
                    <dl>
                        ...
                        <dd>
                            <input type=\"text\" id=\"rol_description\" name=\"rol_description\" style=\"width: 320px;\" maxlength=\"255\" value=\"". htmlspecialchars($role->getValue("rol_description"), ENT_QUOTES). "\">
                        </dd>
                    </dl>
                </li>
                <li>
                ...
                <ul class=\"formFieldList\">
                    ...
                    <li>
                        <dl>
                            ...
                            <dd>
                                <input type=\"text\" id=\"rol_location\" name=\"rol_location\" size=\"30\" maxlength=\"30\" value=\"". htmlspecialchars($role->getValue("rol_location"), ENT_QUOTES). "\">
                            </dd>
                        </dl>
                    </li>
                </ul>
