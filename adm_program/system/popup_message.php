...
switch ($getType)
{
    ...
    case 'cat':
        ...
        break;
    case 'dat':
        $url = SecurityUtils::encodeUrl(ADMIDIO_URL . FOLDER_MODULES . '/events/events_function.php', array('mode' => 2, 'dat_id' => $getDatabaseId));
        break;
    case 'fil':
    ...
    case 'pro_former':
        ...
        break;
    case 'rol':
        $url = SecurityUtils::encodeUrl(ADMIDIO_URL . FOLDER_MODULES . '/roles/roles_function.php', array('mode' => 4, 'rol_id' => $getDatabaseId));
        $text = 'ROL_ROLE_DELETE_DESC';
        break;
    case 'rol_enable':
        $url = SecurityUtils::encodeUrl(ADMIDIO_URL . FOLDER_MODULES . '/roles/roles_function.php', array('mode' => 5, 'rol_id' => $getDatabaseId));
        $text = 'ROL_ENABLE_ROLE_DESC';
        break;
    case 'rol_disable':
        $url = SecurityUtils::encodeUrl(ADMIDIO_URL . FOLDER_MODULES . '/roles/roles_function.php', array('mode' => 3, 'rol_id' => $getDatabaseId));
