...
<div class="modal-footer">
        <button id="btn_yes" class="btn btn-default" type="button" onclick="javascript:callUrlHideElement(\''.$get_element_id.'\', \''.$url.'\''.$callbackFunction.')"><img src="'. THEME_PATH. '/icons/ok.png"
