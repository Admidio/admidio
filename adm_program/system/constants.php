...
define('DOMAIN', $hostParts[0]); // www.example.org | www.myproxy.com
...
define('ADMIDIO_SUB_URL', SECURE_PROXY ? '/' . $host . ADMIDIO_SUBFOLDER : ADMIDIO_SUBFOLDER); // /subfolder | /www.example.com/subfolder
