                ...
                if($lscUsfId > 0)
                {
                    switch ($userFieldType)
                    {
                        case 'CHECKBOX':
                            ...
                            $value = str_replace(array_map('admStrToLower', $arrCheckboxValues), $arrCheckboxKeys, StringUtils::strToLower($value));
                            break;
                        ...
                        case 'RADIO_BUTTON':
                            ...
                            $value = array_search(StringUtils::strToLower($value), array_map('admStrToLower', $arrListValues), true);
                            break;
