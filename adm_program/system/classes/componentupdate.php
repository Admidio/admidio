...
class ComponentUpdate extends Component
{
    ...
    public function updateStepMigrateToStandartMenu()
    {
        ...
        $sql = 'INSERT INTO '.TBL_MENU.' (men_parent_id, men_order, men_standart, men_name_intern, men_url, men_icon, men_name, men_description, men_need_enable)
                   VALUES (NULL, 1, 1, NULL, NULL, \'\', \'SYS_MODULES\', \'\', 0)
                        , (NULL, 2, 1, NULL, NULL, \'\', \'SYS_ADMINISTRATION\', \'\', 1)
                        , (NULL, 3, 1, NULL, NULL, \'\', \'MEN_PLUGIN\', \'\', 1)
                        , (1, 1, 1, \'overview\', \'/adm_program/index.php\', \'home.png\', \'SYS_OVERVIEW\', \'\', 0)
                        , (1, 3, 1, \'download\', \'/adm_program/modules/downloads/downloads.php\', \'download.png\', \'DOW_DOWNLOADS\', \'DOW_DOWNLOADS_DESC\', 1)
                        , (1, 7, 1, \'lists\', \'/adm_program/modules/lists/lists.php\', \'lists.png\', \'LST_LISTS\', \'LST_LISTS_DESC\', 0)
                        , (1, 8, 1, \'mylist\', \'/adm_program/modules/lists/mylist.php\', \'mylist.png\', \'LST_MY_LIST\', \'\', 0)
                        , (1, 2, 1, \'announcements\', \'/adm_program/modules/announcements/announcements.php\', \'announcements.png\', \'ANN_ANNOUNCEMENTS\', \'ANN_ANNOUNCEMENTS_DESC\', 1)
                        , (1, 5, 1, \'photo\', \'/adm_program/modules/photos/photos.php\', \'photo.png\', \'PHO_PHOTOS\', \'PHO_PHOTOS_DESC\', 1)
                        , (1, 6, 1, \'guestbook\', \'/adm_program/modules/guestbook/guestbook.php\', \'guestbook.png\', \'GBO_GUESTBOOK\', \'GBO_GUESTBOOK_DESC\', 1)
                        , (1, 8, 1, \'dates\', \'/adm_program/modules/dates/dates.php\', \'dates.png\', \'DAT_DATES\', \'DAT_DATES_DESC\', 1)
                        , (1, 9, 1, \'weblinks\', \'/adm_program/modules/links/links.php\', \'weblinks.png\', \'LNK_WEBLINKS\', \'LNK_WEBLINKS_DESC\', 1)
                        , (2, 4, 1, \'dbback\', \'/adm_program/modules/backup/backup.php\', \'backup.png\', \'BAC_DATABASE_BACKUP\', \'BAC_DATABASE_BACKUP_DESC\', 0)
                        , (2, 6, 1, \'orgprop\', \'/adm_program/modules/preferences/preferences.php\', \'options.png\', \'SYS_SETTINGS\', \'ORG_ORGANIZATION_PROPERTIES_DESC\', 0)
                        , (1, 4, 1, \'mail\', \'/adm_program/modules/messages/messages_write.php\', \'email.png\', \'SYS_EMAIL\', \'MAI_EMAIL_DESC\', 0)
                        , (2, 1, 1, \'newreg\', \'/adm_program/modules/registration/registration.php\', \'new_registrations.png\', \'NWU_NEW_REGISTRATIONS\', \'NWU_MANAGE_NEW_REGISTRATIONS_DESC\', 0)
                        , (2, 2, 1, \'usrmgt\', \'/adm_program/modules/members/members.php\', \'user_administration.png\', \'MEM_USER_MANAGEMENT\', \'MEM_USER_MANAGEMENT_DESC\', 0)
                        , (2, 3, 1, \'roladm\', \'/adm_program/modules/roles/roles.php\', \'roles.png\', \'ROL_ROLE_ADMINISTRATION\', \'ROL_ROLE_ADMINISTRATION_DESC\', 0)
                        , (2, 5, 1, \'menu\', \'/adm_program/modules/menu/menu.php\', \'application_view_tile.png\', \'SYS_MENU\', \'\', 0)';
        $this->db->query($sql);
