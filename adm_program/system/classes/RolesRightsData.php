 ...
 *
 */
class RolesRightsData extends TableAccess
{
    /**
    ...
    public function logCreation(): bool
    {
        ...
        $role = new TableRoles($this->db, $roleID);
        ...
        switch($objTable) {
            case TBL_FOLDERS:
                $obj = new TableFolder($this->db, $objID);
                break;
            case TBL_CATEGORIES:
                $obj = new TableCategory($this->db, $objID);
                break;
            case TBL_EVENTS:
                $obj = new TableEvent($this->db, $objID);
                break;
            case TBL_MENU:
                $obj = new TableMenu($this->db, $objID);
                break;
            default:
