...
class HtmlFormInstallation extends HtmlForm
{
    ...
    public function show($directOutput = true)
    {
        ...
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="../..'.FOLDER_LIBS_CLIENT.'/bootstrap/css/bootstrap.min.css" />
            <link rel="stylesheet" type="text/css" href="layout/admidio.css" />

            <script type="text/javascript" src="../..'.FOLDER_LIBS_CLIENT.'/jquery/jquery.min.js"></script>
            <script type="text/javascript" src="../..'.FOLDER_LIBS_CLIENT.'/bootstrap/js/bootstrap.min.js"></script>
