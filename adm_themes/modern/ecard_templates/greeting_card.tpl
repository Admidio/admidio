...
<body>
    <div align="center" style="margin-top:30px;">
        <%ecard_greeting_card_from%>: <b><a href="<%g_root_path%>/adm_program/modules/messages/messages_write.php?usr_id=<%ecard_sender_id%>" target="_blank"><%ecard_sender_name%></a></b>
    </div>
